...
docker manifest create bprtkop/sysbox-deploy-k8s:latest --amend "bprtkop/sysbox-deploy-k8s:${VERSION}_$(arch)"
docker manifest push bprtkop/sysbox-deploy-k8s:latest
docker manifest create bprtkop/sysbox-deploy-k8s:"$VERSION" --amend "bprtkop/sysbox-deploy-k8s:${VERSION}_$(arch)"
